...
test_contacts = [
    {
        ...
        "phone_number": "0676650154",
        "birthday": str(date(1984, 12, 13)),
        "additional_data": "additional_data1",
    },
    {
         "first_name": "first2",
        "last_name": "last2",
        "email": "user3@mail.com",
        "phone_number": "0676826627",
        "birthday": str(date(1956, 12, 17)),
...
@pytest.mark.asyncio
async def test_get_contacts_by_id(contact_repository, mock_session, user):
    mock_result = MagicMock()
    contacts_to_get = [
        Contact(
            id=i + 1,
    ...
    contact = await contact_repository.get_contacts_by_id(contact_id=1, user=user)
